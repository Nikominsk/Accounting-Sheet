...
<head>
    ...
    <script src = "../entry/scripts/js/onload/onload.js"></script>

    <script src = "../entry/scripts/js/costs/save-cost.js"></script>
    <script src = "../entry/scripts/js/advance/save-advance.js"></script>
