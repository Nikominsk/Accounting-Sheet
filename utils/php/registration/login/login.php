<?php
    ...
    if(filter_var($usernameOrEmail, FILTER_VALIDATE_EMAIL)) {
        $sql = "SELECT userId, username, email, password, settingId, rankId, active, deleted FROM user WHERE email = '$usernameOrEmail'";
    } else {
        //must be a username
        $sql = "SELECT userId, username, email, password, settingId, rankId, active, deleted FROM user WHERE username = '$usernameOrEmail'";
    }
    ...
    //$profilePicName = file_exists("..\..\..\css\img\profile_img\\".$userId.$username.".jpg") ? $userId.$username.'.jpg' : NULL;

    $profilePicName = file_exists("../../../css/img/profile_img/".$userId.$username.".jpg") ? $userId.$username.'.jpg' : NULL;

    $user = new UserProfile($userId, $username, $rankId, $settingId, $languageId, $language,  $number_formatId, $number_format, $profilePicName);
