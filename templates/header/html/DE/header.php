...
<header>
    ...
    <div id = "profile">
        ...
        <div id = "profile-menu">
            ...
            <div id = "label-signed-name">Angemeldet als <span id = "label-response-username"><?php echo $user->getName(); ?></span></div>

            <a href = "../intern/settings">Einstellungen</a>

            <?php
                //if user is not a normal member
                if($user->getRankId() != 1) {
                    echo '<a href = "../intern/user-settings">Benutzer Einstellungen</a>';
                }

                //if user has highest rank
                if($user->getRankId() == 3) {
                    echo '<a href = "../intern/database-settings">Datenbank Einstellungen</a>';
                }

            ?>

            <a href = "../index" id = "logout-label">Abmelden</a>
        </div>
